...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_FN] = LAYOUT_true_hhkb(
            ...
            _______, KC_LCTL, KC_LALT, KC_DEL, _______, _______, _______, _______, KC_PSCR, KC_LSCR, KC_PAUS, KC_END, KC_HOME, KC_BSPC,
    ...
    [_LIGHTS] = LAYOUT_true_hhkb(
            _______, _______, _______, _______, ________, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______,
            _______, _______, _______, _______, ________, _______,  _______, UML_UE,  _______, UML_OE,  _______, _______, _______, _______,
            KC_CAPS, UML_AE,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, _______,
            _______, BL_TOGG, BL_STEP, UG_TOGG, UG_NEXT, UG_HUEU, UG_SATU, UG_VALU, UG_SPDU, _______, _______, _______, _______, _______,
