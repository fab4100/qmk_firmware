 ...
 */
    [_FN] = LAYOUT_true_hhkb(
            ...
            KC_CAPS, KC_LCTL, KC_LALT, KC_LSFT, _______, _______, _______, _______, KC_PSCR, KC_LSCR, KC_PAUS, KC_HOME, KC_END, KC_BSPC,
            MT(MOD_LCTL, KC_ESC), KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PGDN, KC_PGUP, _______,
            SC_LSPO, _______, _______, KC_MPLY, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 */
    [_LIGHTS] = LAYOUT_true_hhkb(
            ...
            BL_TOGG, _______, BL_DOWN, BL_UP, BL_ON , BL_OFF, BL_BRTG, _______, _______, _______, _______, _______, _______, _______,
